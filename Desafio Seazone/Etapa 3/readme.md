...
Utilizei a primeira coluna para análise pois quero ver a oferta mais vantajosa, o id **85005128** em jurere nacional e o id **2450369092** em jurere internacional aparecem como as oferta de melhor valor segundo a regressão, R$ 240.00 por um apto de 2 quartos e 78 m2. Os apartamentos **2433096197** e **2456757054** aparecem empatados em seguida, ambos com preco de R$ 500.00, 3 quartos e area util similares (isso acontece porque a quantidade de quartos são fatores importantes para o regressor).
